...
public class AdminDashboard extends JFrame {
    ...
    public AdminDashboard(String username) {
        ...
        // Add this logic to your constructor where you define the buttons
        printPayslipBtn.addActionListener(e -> {
            // 1. Prompt for Employee ID (you could also get this from a selected row in a table)
            String empId = JOptionPane.showInputDialog(this, "Enter Employee ID for Payslip:");

            if (empId != null && !empId.trim().isEmpty()) {
                // 2. Pass the ID directly to your generator
                // Ensure you have defined these dates dynamically or via a picker
                reports.ReportGenerator.generatePayslip(empId, "2026-07-01", "2026-07-31");
            }
        });

//        printTimeCardBtn.addActionListener(e -> {
//            // 1. Prompt for Employee ID
//            String empId = JOptionPane.showInputDialog(this, "Enter Employee ID for Timecard:");
//
//            if (empId != null && !empId.trim().isEmpty()) {
//                // 2. Call the generator method (ensure this method exists in ReportGenerator)
//                reports.ReportGenerator.generateTimecard(empId, "2026-07-31");
//            }
//        });
